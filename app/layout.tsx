  ...
  return (
    <>
      <html lang="en" suppressHydrationWarning>
        ...
        <body
          className={cn(
            "min-h-screen font-sans antialiased size-full bg-black bg-[linear-gradient(to_right,#4f4f4f2e_1px,transparent_1px),linear-gradient(to_bottom,#8080800a_1px,transparent_1px)] bg-[size:14px_24px]",
            fontSans.variable
          )}
        >
